...
import type { Merge, MixAttrs, PrefixObject } from '../../types';
 ...
 */
export type ButtonStyleProps = Merge<
  PrefixStyleProps<Omit<MarkerStyleProps, 'style'>, 'marker'>,
  {
    style: GroupStyleProps &
      MixAttrs<PrefixObject<Omit<TextStyleProps, 'text'>, 'text'>> &
      MixAttrs<PrefixObject<RectStyleProps, 'button'>> &
      MixAttrs<PrefixObject<Omit<Pick<MarkerStyleProps, 'style'>['style'], 'symbol'>, 'marker'>> & {
         ...
         */
        text?: string;
        markerSymbol?: MarkerStyleProps['style']['symbol'];
        /**
