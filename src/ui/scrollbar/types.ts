import type { GroupStyleProps, RectStyleProps } from '@antv/g';
import type { ComponentOptions, RequiredStyleProps } from '../../core';
...
export type ScrollbarStyleProps = {
  style: GroupStyleProps &
    ...
    PrefixObject<RectStyleProps, 'thumb'> & {
       ...
       * 滑条朝向
       */
      orientation?: RequiredStyleProps<SliderStyleProps>['style']['orientation'];
