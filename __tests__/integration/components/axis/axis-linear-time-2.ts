...
export const AxisLinearTime2 = it({ width: 500, height: 350 }, (group) => {
  ...
  const halfHour = createTimeData('2023-01-01 22:00:00', 'half-hour', 6).map(formatter);
  const hour = createTimeData('2023-01-01 22:00:00', 'hour', 6).map(formatter);
  const fourHour = createTimeData('2023-01-01 22:00:00', 'four-hour', 6).map(formatter);
  const halfDay = createTimeData('2023-01-01 06:00:00', 'half-day', 3).map(formatter);
  const day = createTimeData('2023-01-01 06:00:00', 'day', 6).map(formatter);
  const week = createTimeData('2023-01-01 06:00:00', 'week', 6).map(formatter);
  const month = createTimeData('2022-12-01 00:00:00', 'month', 6).map(formatter);
  const season = createTimeData('2022-10-01 00:00:00', 'season', 6).map(formatter);
  const year = createTimeData('2018-01-01 00:00:00', 'year', 6).map(formatter);
  ...
  createAxis(year, 330, (time: dayjs.Dayjs) => time.format('YYYY'));
});
