...
export const AxisLinearTitle = () => {
  ...
  createAxis({
    ...
    endPos: [600, 450],
    titlePosition: 'lt',
    titleTransform: 'translate(-100%, 100%)',
  });
  createAxis({ startPos: [650, 50], endPos: [650, 450], titlePosition: 'l', titleTransform: 'translate(-100%, 0)' });
  createAxis({
    startPos: [700, 50],
    endPos: [700, 450],
    titlePosition: 'lb',
  ...
  createAxis({
    ...
    endPos: [750, 450],
    titlePosition: 'rt',
    titleTransform: 'translate(50%, 100%)',
  });
  createAxis({ startPos: [800, 450], endPos: [800, 50], titlePosition: 'r', titleTransform: 'translate(50%, 0)' });
  createAxis({
    startPos: [850, 450],
    endPos: [850, 50],
    titlePosition: 'rb',
